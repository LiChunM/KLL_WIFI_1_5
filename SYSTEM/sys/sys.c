...
void Update_All(void)
{
	...
	if(adcvols.PA3VOL>1300)my_core_data.speed=(adcvols.PA3VOL-1300)*255/1900;
	else	my_core_data.speed=0;
	if(my_core_data.speed>=240)my_core_data.speed=0xff;
	...
	if(adcvols.PA4VOL>3100||adcvols.PA4VOL<800)
		{
